...
def load_data(data_dir):
    ...
    for directory in os.listdir(data_dir):
        ...
        for file in os.listdir(os.path.join(data_dir, directory)):
            ...
            images.append(image)
            labels.append(int(directory,base=10))
        print(f"Successfully import image datasets from {directory} directory")
        count=count+1
    ### Display the status of the datasets import
